// src/data/chemistryGameQuiz.js
import { chemistryLessons } from './chemistryLessons';

/**
 * Build a flattened question bank from chemistryLessons.
...
// gather all quizzes
chemistryLessons.forEach((lesson) => {
...
if (questionBank.length === 0) {
  questionBank.push({
    question: 'Chemistry contributes to the economy through:',
