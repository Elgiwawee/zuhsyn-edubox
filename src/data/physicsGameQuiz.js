// src/data/physicsGameQuiz.js
import { physicsLessons } from './physicsLessons';

/**
 * Build a flattened question bank from physicsLessons.
...
if (questionBank.length === 0) {
  questionBank.push({
    question: 'Physics contributes to the economy through:',
