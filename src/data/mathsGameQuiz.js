// src/data/mathsGameQuiz.js
import { mathsLessons } from './mathsLessons';

/**
 * Build a flattened question bank from mathsLessons.
...
if (questionBank.length === 0) {
  questionBank.push({
    question: 'Mathematics contributes to the economy through:',
