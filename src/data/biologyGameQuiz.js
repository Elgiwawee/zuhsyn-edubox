// src/data/biologyGameQuiz.js
import { biologyLessons } from './biologyLessons';

/**
 * Build a flattened question bank from biologyLessons.
...
if (questionBank.length === 0) {
  questionBank.push({
    question: 'Biology contributes to the economy through:',
