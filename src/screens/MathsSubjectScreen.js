...
import { mathsTopics } from '../data/mathsTopics';
  ...
  return (
    ...
    >
      ...
      <Show when={loading !== true}>
        ...
        {/* ================= TOPICS ================= */}
        <Show when={Array.isArray(mathsTopics)}>
          {mathsTopics.map((topic, index) => {
            ...
            const navigateTopic = () => {
              if (
                topicText.toLowerCase().includes('maths runner game')
              ) {
                navigation.navigate('MathsGame');
              } else {
                navigation.navigate('MathsLessonDetail', {
                  topicIndex: index,
                });
              }
            };
