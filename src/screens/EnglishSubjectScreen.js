...
const SUBJECT_NAME = 'English Language';
  ...
  return (
      ...
      >
        ...
        <Show when={loading !== true}>
          ...
          {/* ================= TOPICS ================= */}
          <Show when={Array.isArray(englishTopics)}>
            {englishTopics.map((topic, index) => {
              ...
              const navigateTopic = () => {
                if (
                  topicText.toLowerCase().includes('english runner game')
                ) {
                  navigation.navigate('EnglishcGame');
                } else {
                  navigation.navigate('EnglishLessonDetail', {
                    topicIndex: index,
                  });
                }
              };
