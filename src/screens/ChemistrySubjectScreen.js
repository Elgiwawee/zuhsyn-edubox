  ...
  return (
      ...
      >
        ...
        <Show when={loading !== true}>
          ...
          {/* ================= TOPICS ================= */}
          <Show when={Array.isArray(chemistryTopics)}>
            {chemistryTopics.map((topic, index) => {
              ...
              const navigateTopic = () => {
                if (
                  topicText.toLowerCase().includes('chemistry runner game')
                ) {
                  navigation.navigate('ChemistryGame');
                } else {
                  navigation.navigate('ChemistryLessonDetail', {
                    topicIndex: index,
                  });
                }
              };
