  ...
  return (
      ...
      >
        ...
        <Show when={loading !== true}>
          ...
          {/* ================= TOPICS ================= */}
          <Show when={Array.isArray(biologyTopics)}>
            {biologyTopics.map((topic, index) => {
              ...
              const navigateTopic = () => {
                if (
                  topicText.toLowerCase().includes('biology runner game')
                ) {
                  navigation.navigate('BiologyGame');
                } else {
                  navigation.navigate('BiologyLessonDetail', {
                    topicIndex: index,
                  });
                }
              };
              ...
              return (
                ...
                >
                  <TouchableOpacity
                    style={[
                      styles.topic,
                      isCompleted && styles.topicDisabled,
                    ]}
...
export default BiologySubjectScreen;
