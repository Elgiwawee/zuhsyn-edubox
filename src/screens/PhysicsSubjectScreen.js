  ...
  return (
      ...
      >
        ...
        <Show when={loading !== true}>
          ...
          {/* ================= TOPICS ================= */}
          <Show when={Array.isArray(physicsTopics)}>
            {physicsTopics.map((topic, index) => {
              ...
              const navigateTopic = () => {
                if (
                  topicText.toLowerCase().includes('physics runner game')
                ) {
                  navigation.navigate('PhysicsGame');
                } else {
                  navigation.navigate('PhysicsLessonDetail', {
                    topicIndex: index,
                  });
                }
              };
